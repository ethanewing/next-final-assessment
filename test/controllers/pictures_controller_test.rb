...
class PicturesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create picture" do
    assert_difference('Picture.count') do
      post pictures_url, params: { picture: { description: @picture.description, path: @picture.path } }
    end
  ...
  test "should update picture" do
    patch picture_url(@picture), params: { picture: { description: @picture.description, path: @picture.path } }
